...
export type BucketSize = 'auto' | '5 MINUTE' | '10 MINUTE' | '15 MINUTE' | '30 MINUTE' | '1 HOUR'
...
const validBuckets: Set<string> = new Set(['auto', '5 MINUTE', '10 MINUTE', '15 MINUTE', '30 MINUTE', '1 HOUR'])
