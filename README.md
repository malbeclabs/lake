...
| `read_docs` | Read DoubleZero documentation (fetched from malbeclabs/docs) |
| `get_onboarding_runbook` | Guided onboarding walkthrough; omit `service` to list. Catalog is GitHub raw `docs/runbooks.md`; runbook bodies are also fetched from raw docs. |
