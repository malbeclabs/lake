...
-- Add is_provisioning flag to dz_links_health_current
-- True when committed_rtt_ns = 1000000000 (1000ms sentinel value for provisioning links)
...
-- +goose Down
-- Restore previous view without is_provisioning
-- +goose StatementBegin
CREATE OR REPLACE VIEW dz_links_health_current
AS
WITH recent_latency AS (
