-- +goose Up
--
-- Track bgp_status in the users section of entity_changes_v so a real BGP
-- up/down transition renders as changed_fields=['bgp_status'] in the timeline
-- instead of a contentless "updated (0 fields)" event. Follow-up to the BGP
-- ingestion (20260708000001); requested in review of #685.
