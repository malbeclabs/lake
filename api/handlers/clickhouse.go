...
// safeQueryRows wraps envDB().Query and guarantees that when an error is
...
func (a *API) safeQueryRows(ctx context.Context, query string, args ...any) (driver.Rows, error) {
