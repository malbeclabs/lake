...
// enriched_ip_mroute_oifs view. The view handles OIF expansion
// (ARRAY JOIN on oif_list), classification (oif_kind /
// observed_delivery_role), and all of underlay-link / subscriber-tunnel /
// local-interface enrichment. See
// indexer/db/clickhouse/migrations/20260602000003_enriched_ip_mroute_oifs_view.sql.
//
// Streams every OIF for the group; no silent cap. Optional Limit / Offset
// pagination applied by the handler if requested.
