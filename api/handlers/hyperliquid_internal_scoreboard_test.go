...
func TestGetHyperliquidInternalScoreboard_Empty(t *testing.T) {
	...
	api.GetHyperliquidInternalScoreboard(rr, req)

	require.Equal(t, http.StatusOK, rr.Code)
	var resp handlers.HyperliquidInternalScoreboardResponse
...
func TestHyperliquidInternalScoreboard_PerNode(t *testing.T) {
	api := apitesting.NewTestAPIBare(t, testChDB)
...
func TestHyperliquidInternalScoreboard_RecentRaces(t *testing.T) {
	api := apitesting.NewTestAPIBare(t, testChDB)
	createFeedsTable(t, api)
	...
	races, err := api.FetchHyperliquidInternalScoreboardData(t.Context(), "24h", "")
	require.NoError(t, err)
...
func TestHyperliquidInternalScoreboard_HeadlineAndCompetitors(t *testing.T) {
	api := apitesting.NewTestAPIBare(t, testChDB)
	createFeedsTable(t, api)
