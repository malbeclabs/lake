...
// enriched_ip_mroute view. All device/metro/contributor/group/publisher
// joins live in the view definition (see
// indexer/db/clickhouse/migrations/20260602000001_enriched_ip_mroute_view.sql).
//
// Streams all mroutes for the group; the handler applies optional Limit /
// Offset slicing if the caller asked for pagination. No silent cap.
